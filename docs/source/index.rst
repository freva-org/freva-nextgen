...
------------------------
This documentation describes the *freva databrowser* client library, its
command line interface (cli) and the REST API. The *freva databrowser*
is a powerful tool that enables you to search
