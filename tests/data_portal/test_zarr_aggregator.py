"""Tests for the Zarr aggregation helpers.

This test suite exercises functionality in the data portal worker's Zarr
aggregation module. It ensures aggregation utilities behave correctly under
various scenarios, including error handling, inference of concatenation
dimensions, grouping strategies, and writing grouped Zarr metadata.  These
tests are self‑contained and do not depend on the REST API or client layers.
"""
