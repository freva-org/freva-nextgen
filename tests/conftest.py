...
@pytest.fixture(scope="function")
def user_data_payload_sample() -> Dict:
    """Create a user data payload."""
    return {'user_metadata': [{'variable': 'ua', 'time_frequency': 'mon', 'time': '[1979-01-16T12:00:00Z TO 1979-11-16T00:00:00Z]', 'cmor_table': 'mon', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/global/cmip6/CMIP6/CMIP/MPI-M/MPI-ESM1-2-LR/amip/r2i1p1f1/Amon/ua/gn/v20190815/ua_mon_MPI-ESM1-2-LR_amip_r2i1p1f1_gn_197901-199812.nc'}, {'variable': 'ua', 'time_frequency': 'mon', 'time': '[1979-01-16T12:00:00Z TO 1979-11-16T00:00:00Z]', 'cmor_table': 'mon', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/global/cmip6/CMIP6/CMIP/CSIRO-ARCCSS/ACCESS-CM2/amip/r1i1p1f1/Amon/ua/gn/v20201108/ua_Amon_ACCESS-CM2_amip_r1i1p1f1_gn_197901-201412.nc'}, {'variable': 'ua', 'time_frequency': 'mon', 'time': '[1979-01-16T12:00:00Z TO 1979-11-16T00:00:00Z]', 'cmor_table': 'mon', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/global/cmip6/CMIP6/CMIP/CSIRO-ARCCSS/ACCESS-CM2/amip/r1i1p1f1/Amon/ua/gn/v20191108/ua_Amon_ACCESS-CM2_amip_r1i1p1f1_gn_197001-201512.nc'}, {'variable': 'pr', 'time_frequency': '3h', 'time': '[2007-01-02T01:30:00Z TO 2007-01-02T04:30:00Z]', 'cmor_table': '3h', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/regional/cordex/output/EUR-11/GERICS/NCC-NorESM1-M/rcp85/r1i1p1/GERICS-REMO2015/v1/3hr/pr/v20181212/pr_EUR-11_NCC-NorESM1-M_rcp85_r1i1p1_GERICS-REMO2015_v2_3hr_200701020130-200701020430.nc'}, {'variable': 'tas', 'time_frequency': 'day', 'time': '[1949-12-01T12:00:00Z TO 1949-12-10T12:00:00Z]', 'cmor_table': 'day', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/regional/cordex/output/EUR-11/CLMcom/MPI-M-MPI-ESM-LR/historical/r0i0p0/CLMcom-CCLM4-8-17/v1/fx/orog/v20140515/orog_EUR-11_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-CCLM4-8-17_v1_fx.nc'}, {'variable': 'tas', 'time_frequency': 'day', 'time': '[1949-12-01T12:00:00Z TO 1949-12-10T12:00:00Z]', 'cmor_table': 'day', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/regional/cordex/output/EUR-11/CLMcom/MPI-M-MPI-ESM-LR/historical/r1i1p1/CLMcom-CCLM4-8-17/v1/daypt/tas/v20140515/tas_EUR-11_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-CCLM4-8-17_v1_daypt_194912011200-194912101200.nc'}], 'facets': {'project': 'cmip5', 'experiment': 'myFavExp'}}

@pytest.fixture(scope="function")
def user_data_payload_sample_partially_success() -> Dict:
    return {'user_metadata': [{'variable': 'ua', 'time_frequency': 'mon', 'time': '[1979-01-16T12:00:00Z TO 1979-11-16T00:00:00Z]', 'cmor_table': 'mon', 'version': '', 'file': 'freva-rest/src/databrowser_api/mock/data/model/global/cmip6/CMIP6/CMIP/MPI-M/MPI-ESM1-2-LR/amip/r2i1p1f1/Amon/ua/gn/v20190815/ua_mon_MPI-ESM1-2-LR_amip_r2i1p1f1_gn_197901-199812.nc'}, {'variable': 'ua', 'time_frequency': 'mon', 'time': '[1979-01-16T12:00:00Z TO 1979-11-16T00:00:00Z]', 'cmor_table': 'mon', 'version': '', 'file': ''}, {'variable': 'tas', 'time_frequency': 'day', 'time': 'fx', 'file': 'freva-rest/src/databrowser_api/mock/data/model/regional/cordex/output/EUR-11/CLMcom/MPI-M-MPI-ESM-LR/historical/r0i0p0/CLMcom-CCLM4-8-17/v1/fx/orog/v20140515/orog_EUR-11_MPI-M-MPI-ESM-LR_historical_r1i1p1_CLMcom-CCLM4-8-17_v1_fx.nc'}], 'facets': {'project': 'cmip5', 'experiment': 'myFavExp'}}